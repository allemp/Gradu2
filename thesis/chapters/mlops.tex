...
Several workflows for developing machine learning systems have emerged attempting to standardize the overall development process including CRISP-DM \parencite{wirthCrispdmStandardProcess2000} and KDD \parencite{fayyadKnowledgeDiscoveryData1996}.
These workflows will overall have similar steps. Using CRISP-DM as an example we have the following steps in the workflow \parencite{wirthCrispdmStandardProcess2000}:
