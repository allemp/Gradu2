...
\improvement{define workload}

Both training loss and validation loss decreased during training for each workload as seen in figure \improvement{add figure}. Accuracy did not clearly increase or decrease during model training on classification workloads demonstrated by figure \improvement{add figure}. For regression workloads RSME decreased like training and test loss metrics seen in figure \improvement{add figure}.
